...
class Escrita():
    def __init__(self):
        self.dirImage = None
        self.os = Os()
        self.dirSaveEscrita = r'\webScraping\Projeto\Controle\Textos'
        pytesseract.pytesseract.tesseract_cmd = r'C:/Program Files/Tesseract-OCR/tesseract.exe'

    def defineTextPdfPath(self):
        diretorio = r'C:\Users\CPGT\Desktop\webScraping\Projeto\Controle\Download\matrizes_curriculares'
